...
export function Hero() {
  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
          ...
          <motion.div
            ...
            className="relative col-span-1 mx-auto flex justify-center lg:col-span-5"
          >
            <div className="relative w-80 h-80 lg:w-96 lg:h-96">
                <svg
                  className="absolute top-1/2 left-1/2 h-[125%] w-[125%] -translate-x-1/2 -translate-y-1/2 text-primary"
                  viewBox="0 0 578 544"
                  fill="none"
      ...
      >
        <Link href="#about" aria-label="Scroll to about section" className='flex items-center gap-2 text-muted-foreground transition-colors hover:text-foreground'>
